...
/>
<Text style={{textAlignVertical:'center', position:'relative',left:12}}> ethan001</Text>
<TouchableOpacity>
...
<Image source={(require('../assets/postImageOne.jpg'))}
...
{heartfilled ? 
    <Text style={{marginLeft:88, marginVertical:5}}>Liked by emmali09 and 51 others</Text>
     :
     <Text style={{marginLeft:88, marginVertical:5}}>Liked by emmali09 and 50 others</Text>
}
</View>
<View style={{height:20, width:"100%",flexDirection:'row' }}>
<Text style={{fontWeight:'bold', marginLeft:15}}>ethan001</Text>
<Text style={{marginLeft:15}}>Landscape View</Text>
</View>
<Text style={{marginLeft:15, color:'#A9A9A9'}}>View all 3 comments</Text>
<View style={{height:20, width:"100%",flexDirection:'row' }}>
<Text style={{fontWeight:'bold', marginLeft:15}}>nikkibeg13</Text>
<Text style={{marginLeft:15}}>Lovely View</Text>
<Image source={(require('../assets/like.png'))}
    style={{height:15, width:15, tintColor:'#D0D0D0',marginVertical:1, marginLeft:220}}
/>
</View>
...
<Text style={{marginLeft:15, marginTop:10, color:'#A9A9A9'}}>3 hour ago</Text>
</View>
