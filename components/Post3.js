...
/>
<Text style={{textAlignVertical:'center', position:'relative',left:12}}> nikkibeg13</Text>
<TouchableOpacity>
...
{heartfilled ? 
    <Text style={{marginLeft:88, marginVertical:5}}>Liked by emmali09 and 60 others</Text>
     :
     <Text style={{marginLeft:88, marginVertical:5}}>Liked by emmali09 and 59 others</Text>
}
</View>
<View style={{height:20, width:"100%",flexDirection:'row' }}>
<Text style={{fontWeight:'bold', marginLeft:15}}>nikkibeg13</Text>
<Text style={{marginLeft:15}}>Mountains</Text>
</View>
...
<Text style={{marginLeft:15, marginTop:10, color:'#A9A9A9'}}>12 hour ago</Text>
</View>
